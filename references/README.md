...
All references for *Cloud-Based Smart Irrigation Recommendation using Weather
Intelligence* (BITE412L, Dr. Priya V), in **IEEE citation format**.

---

## Research papers (15)

Every citation below was verified against the publisher's own record. All are from
2023–2025 and from IEEE, Springer, Elsevier, ACM, Wiley, MDPI or other
Scopus-indexed venues, per the Phase-I guidelines.
...
[4] H. M. Abd El Baki, H. Fujimaki, I. Tokumoto, and T. Saito, "Optimization of irrigation scheduling using crop–water simulation, water pricing, and quantitative weather forecasts," *Frontiers in Agronomy*, vol. 6, art. 1376231, 2024, doi: 10.3389/fagro.2024.1376231.

[5] S. Mohamed Naziq, N. K. Sathyamoorthy, Ga. Dheebakaran, S. Pazhanivelan, and N. Vadivel, "Coupled weather and crop simulation modeling for smart irrigation planning: A review," *Water Supply*, vol. 24, no. 8, pp. 2844–2865, Aug. 2024, doi: 10.2166/ws.2024.170.
...
[16] L. Poggio, L. M. de Sousa, N. H. Batjes, G. B. M. Heuvelink, B. Kempen, E. Ribeiro, and D. Rossiter, "SoilGrids 2.0: Producing soil information for the globe with quantified spatial uncertainty," *SOIL*, vol. 7, pp. 217–240, 2021, doi: 10.5194/soil-7-217-2021.

[17] Open-Meteo, "Free open-source weather API." [Online]. Available: https://open-meteo.com/. Data licensed under CC BY 4.0.

[18] NASA Langley Research Center, "NASA POWER: Prediction of Worldwide Energy Resources." [Online]. Available: https://power.larc.nasa.gov/. Data licensed under CC BY 4.0.

[19] ISRIC — World Soil Information, "SoilGrids — global gridded soil information." [Online]. Available: https://soilgrids.org/. Data licensed under CC BY 4.0.

[20] International Soil Moisture Network. [Online]. Available: https://ismn.earth/.

---

## Standards and methodological references

[21] R. G. Allen, L. S. Pereira, D. Raes, and M. Smith, *Crop Evapotranspiration: Guidelines for Computing Crop Water Requirements*, FAO Irrigation and Drainage Paper 56. Rome, Italy: Food and Agriculture Organization of the United Nations, 1998.

---

## Paper allocation reference

| Student | Register Number | References |
|---|---|---|
...
References [17] to [19] are CC BY 4.0 and require attribution wherever their data
is displayed. The deployed dashboard will carry:

> Weather data by Open-Meteo.com · Meteorological data from the NASA POWER Project
> · Soil data from ISRIC — World Soil Information (SoilGrids)
